...
function Download-PackageManager {
    ...
    if (Test-Path "$InstallDir\.git") {
        ...
        try {
            ...
            Write-Host "⚠️  Update failed: $($_.Exception.Message)" -ForegroundColor Yellow
            Write-Host "📥 Downloading fresh copy..." -ForegroundColor Yellow
            Pop-Location
            ...
            if (Test-Path $InstallDir) {
                ...
                try {
                    ...
                    Write-Host "⚠️  Could not remove old directory: $($_.Exception.Message)" -ForegroundColor Yellow
                }
            }
